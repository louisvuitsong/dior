...
success:function(data){
    ...
    let title, imgSrc, detail, tagList='';
    ...
    let handTitle, handImgSrc, handDetail, handPrice, handQrImgSrc, handAlt, handTagList ='';
    ...
    let toteTitle, toteImgSrc, toteDetail, totePrice, toteQrImgSrc, toteAlt, toteTagList ='';
    ...
    let miniTitle, miniImgSrc, miniDetail, miniPrice, miniQrImgSrc, miniAlt, miniTagList ='';
    ...
    $.ajax({
        ...
        success:function(db){
            ...
            let detailImg1, detailImg2, detailImg3, state;
            let proTitle, proMade, proNum, proPrice, proExp;
            let li1, li2, li3, li4, li5, li6, li7, li8;
